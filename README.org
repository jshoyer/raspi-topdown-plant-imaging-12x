...
This branch, however, has cron tables for long (16-hour) days,
...
will just cause error messages/overnight sync delays
and not missed timepoints or loss of data.

The following table of UTC times
may help you interpret the server cron table
on this particular code branch.
